 ...
 * (fonction exportée `proxy`, plus `middleware`) : `apps/storefront/src/middleware.ts` provoquait
...
export const config = {
  // Exclut les assets statiques Next et les préfetchs `next/link` (recommandation officielle de la
  // doc citée ci-dessus) — inutile de calculer un nonce pour eux.
  matcher: [
    {
